...
partial def matchComplexLinear (e : Expr) : Option (Expr × Expr) :=
  ...
  | atan _ | asin _ | acos _ | sec _ | csc _ | cot _
  | factorial _ | gamma _ | floor _ | Expr.ite _ _ _ | ln _ | exp _ | abs _ | var _ | pow _ _ =>
    -- treat as real
    some (e, zero)
...
partial def eulerExpand1 (e : Expr) : Expr :=
  ...
  | asin a => asin (eulerExpand1 a)
  | acos a => acos (eulerExpand1 a)
  | sec a => sec (eulerExpand1 a)
  | csc a => csc (eulerExpand1 a)
  | cot a => cot (eulerExpand1 a)
  | factorial a => factorial (eulerExpand1 a)
  | gamma a => gamma (eulerExpand1 a)
  | floor a => floor (eulerExpand1 a)
  | Expr.ite c t e => Expr.ite (eulerExpand1 c) (eulerExpand1 t) (eulerExpand1 e)
  ...
  | lt a b => lt (eulerExpand1 a) (eulerExpand1 b)
  | le a b => le (eulerExpand1 a) (eulerExpand1 b)
